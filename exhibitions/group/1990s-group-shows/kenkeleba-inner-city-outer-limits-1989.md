<style>
  ...
  .top-nav a {
    ...
    transition:background .25s ease,box-shadow .25s ease,transform .15s ease,color .25s ease,border-color .25s ease;
  }
  .top-nav a:hover{
...
➡️ **[Return to 1980s Group Exhibitions](../1980s-group-exhibitions.html#kenkeleba-inner-city-outer-limits-1989-row)**
